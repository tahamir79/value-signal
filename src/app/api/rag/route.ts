...
type RagPayload={query:string;ticker?:string;form?:string;mode?:string;topK?:number;synthesize?:boolean};
...
export async function POST(request:NextRequest){
  ...
  try{
    const result=await runPythonRag({query,ticker:ticker||undefined,form:form||undefined,mode,topK,synthesize:body?.synthesize!==false});
