...
type RagResult={answer?:string|null;limitations?:string|null;warnings?:string[];citations?:string[];retrieved_chunks?:RagChunk[];retrieval_mode?:string;intent?:string;error?:string;official_signal?:string;official_signal_label?:string;signal_confidence?:string;evidence_assessment?:string;deterministic_risk_posture?:string;stock_context?:{scores?:Record<string,number|null>;rawFeatures?:Record<string,number|null>;missingFeatures?:string[]}};
