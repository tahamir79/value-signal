...
class RagPipelineTests(unittest.TestCase):
    ...
    def test_stock_context_prompt_and_assessment(self):
        ...
        self.assertNotIn("Raw features: earnings_yield=0.1",prompt)
        full_prompt=build_prompt("debug raw features",CHUNKS,ticker="COST",stock_context={"officialSignalLabel":"Value trap risk","officialSignal":"value-trap-risk","confidence":"High","scores":{"value":90},"rawFeatures":{"earnings_yield":.1}})
        self.assertIn("Raw features: earnings_yield=0.1",full_prompt)
    ...
    def test_deep_research_profile_and_fields(self):
        ...
        self.assertIn("What the SEC Evidence Adds:",prompt)
